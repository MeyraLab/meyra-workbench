...
export const APPS: AppEntry[] = [
  ...
  { name: 'InkPai', icon: 'inkpai', role: 'now', url: 'https://inkpai.lovable.app' },
  ...
  { name: 'Manus', icon: 'manus', role: 'explore', url: 'https://manus.im' },
  ...
  { name: 'Component Gallery', icon: 'componentGallery', role: 'explore', url: 'https://component.gallery' },
  { name: 'Curations', icon: 'curations', role: 'explore', url: 'https://www.curations.supply' },
  { name: 'Flowbite', icon: 'flowbite', role: 'explore', url: 'https://flowbite.com' },
  { name: 'Material', icon: 'material', role: 'explore', url: 'https://m3.material.io' },
  { name: 'Apple HIG', icon: 'appleHig', role: 'explore', url: 'https://developer.apple.com/design/human-interface-guidelines' },
  { name: 'TOOOLS', icon: 'toools', role: 'explore', url: 'https://www.toools.design' },
  { name: 'Mobbin', icon: 'mobbin', role: 'explore', url: 'https://mobbin.com' },
  { name: '墨排', icon: 'mopai', role: 'explore', url: 'https://inkpai.lovable.app' },
  { name: '书摘卡片', icon: 'bookCard', role: 'explore', url: 'https://github.com/MeyraLab' },
  { name: '图片书摘', icon: 'imageQuote', role: 'explore', url: 'https://github.com/MeyraLab' },
